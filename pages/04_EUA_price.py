...
#---------------------------------------------------------------------------------------------------------
st.markdown("""
            ### 📈 EU Allowance (EUA) price yearly average (EUR/tCO2)
...
fig_bar = px.bar(
                ...
                x="year",
                y="price",
                text="price"  # show value labels
)

fig_bar.update_traces(
                width=0.6,               # makes the bars thinner (0 to 1)
                textposition="outside",  # place the label above the bar
                marker_line_width=0.5,   # optional: outline the bars slightly
